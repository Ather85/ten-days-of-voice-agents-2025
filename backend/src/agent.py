...
# 👨‍⚕️ "Skill Up Academy" - Auto-Lead Capture Agent
...
print("📚 SELLING: Skill Up Academy's Cloud & AI Courses")
...
# Default FAQ data for "Skill Up Academy"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Skill Up Academy releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Skill Up Academy'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check and email you." (Don't hallucinate prices).
            """,
